...
safeIndex xs i = if (i >=0)  && (length xs > i)
...
addEithers (Left str1) (Right int2) = Left (str1)
addEithers (Right int1) (Left str2) = Left (str2)
addEithers (Right int1) (Right int2) = Right (int1 +int2)  
